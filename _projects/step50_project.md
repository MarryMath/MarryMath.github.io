...
layout: page
title: project 50
description: SES-Step50 通用大学英语第一学期期中
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/step50/50-3.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/step50/50-4.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
